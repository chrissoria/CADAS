	...
	*replace c_72_1_pic = c_72_1_pic + ".jpg" if !strpos(c_72_1_pic, ".jpg")
	...
	save"../DR_in/ty_4_image_scoring.dta", replace
     ...
     forvalues i = 1/4 {
		...
		if `i' == 2 {
			replace c_72_2_ai_score = c_72_2_ai_score + 1
			replace c_72_2_ai_score_strict = c_72_2_ai_score_strict + 1
		}
    ...
    forvalues i = 1/4 {
		...
		if `i' == 2 {
			replace c_79_2_ai_score = c_79_2_ai_score + 1
		}
		rename drawing_present drawing_present_79_`i'
        save "../DR_in/c_79_`i'_machine_score.dta", replace
    }
    
    import delimited using "../DR_in/final_AI_scores/pent_scoring.csv", stringcols(_all) clear
...
*collapse circles
*0 / 1,2
gen collapsed_72_1_ai = 0 if c_72_1_ai_score_strict == 0
replace collapsed_72_1_ai = 1 if c_72_1_ai_score_strict == 1 | c_72_1_ai_score_strict == 2

gen collapsed_79_1_ai = 0 if c_79_1_score_strict_ai == 0
replace collapsed_79_1_ai = 1 if c_79_1_score_strict_ai == 1 | c_79_1_score_strict_ai == 2
...
*collapse diamonds
*0,1 / 2,3 
gen collapsed_72_2_ai = 0 if c_72_2_ai_score_strict == 0 | c_72_2_ai_score_strict == 1
replace collapsed_72_2_ai = 1 if c_72_2_ai_score_strict == 2 | c_72_2_ai_score_strict == 3

gen collapsed_79_2_ai = 0 if c_79_2_ai_score == 0 | c_79_2_ai_score == 1
replace collapsed_79_2_ai = 1 if c_79_2_ai_score == 2 | c_79_2_ai_score == 3
...
*0 / 1 / 2
gen collapsed_72_3_ai = c_72_3_ai_score
gen collapsed_79_3_ai = c_79_3_ai_score
...
*collapse cubes
*0,1 / 2 / 3,4
gen collapsed_72_4_ai = 0 if c_72_4_ai_score == 0 | c_72_4_ai_score == 1
replace collapsed_72_4_ai = 2 if c_72_4_ai_score == 2
replace collapsed_72_4_ai = 4 if c_72_4_ai_score == 3 | c_72_4_ai_score == 4

gen collapsed_79_4_ai = 0 if c_79_4_ai_score == 0 | c_79_4_ai_score == 1
replace collapsed_79_4_ai = 2 if c_79_4_ai_score == 2
replace collapsed_79_4_ai = 4 if c_79_4_ai_score == 3 | c_79_4_ai_score == 4
...
foreach var in `imagescoring' {
	...
	foreach response in `scores' {
		egen c_`var'_ai_avg_if_`response' = mean(c_`var'_ai_cleaned) if cs_`var' == `response'
	}
}
