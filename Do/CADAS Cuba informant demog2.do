...
set more off
capture log close
log using "CADAS Cuba informant demog2", text replace

**********
* Look for Cuban cases with Informant demographics that are appear to be from participant instead
* Input consensus data from 2024_11_24
* WDow 12/19/24
**********

use "old ConsensusVariables - Cuba.dta", clear
d,s
