...
* Any globalrecordid3 codes that need to be dropped should be added to the line below

gen drop = "drop" if inlist(globalrecordid, "fbe37e27-4b82-4d14-8c82-cc10a8b331cc")
...
merge 1:1 globalrecordid using dropsheet1.dta
...
merge 1:1 globalrecordid using dropsheet2.dta
...
export excel using "`path'/DR_out/duplicates/door_duplicates.xlsx", replace firstrow(variables)
