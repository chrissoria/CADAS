...
replace cs_79_1 = .i if (cs_79_1 == . | cs_72_9 == .i) & (c_79_1 ~= 6 & c_79_1 ~= 7)
replace cs_79_1 = .v if (cs_79_1 == . | cs_72_9 == .i) & (c_79_1 == 6 | c_79_1 == 7)

replace cs_79_2 = .i if (cs_79_2 == . | cs_72_9 == .i) & (c_79_2 ~= 6 & c_79_2 ~= 7)
replace cs_79_2 = .v if (cs_79_2 == . | cs_72_9 == .i) & (c_79_2 == 6 | c_79_2 == 7)

replace cs_79_3 = .i if (cs_79_3 == . | cs_72_9 == .i) & (c_79_3 ~= 6 & c_79_3 ~= 7)
replace cs_79_3 = .v if (cs_79_3 == . | cs_72_9 == .i) & (c_79_3 == 6 | c_79_3 == 7)

replace cs_79_4 = .i if (cs_79_4 == . | cs_72_9 == .i) & (c_79_4 ~= 6 & c_79_4 ~= 7)
replace cs_79_4 = .v if (cs_79_4 == . | cs_72_9 == .i) & (c_79_4 == 6 | c_79_4 == 7)
