...
set more off
capture log close
log using Household, text replace

 cd "/hdir/0/chrissoria/Stata_CADAS/Data/House"
 
   insheet using "HouseholdChild.csv", comma names clear
...
label variable s_3_13 "3.13 ¿El combustible que más usan para cocinar es..."
